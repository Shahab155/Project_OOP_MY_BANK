...
let customers: Customer[]= [
    new Customer("Shahab","Ud Din","Male",20,3022187590,accounts[0]),
    new Customer("Mazhar","Khan","Male",27,3008938194,accounts[1]),
    new Customer("Sadar","Bhutto","Male",28,3113904009,accounts[2])
];
